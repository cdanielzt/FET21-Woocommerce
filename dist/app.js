...
var countDownDate = new Date("Nov 5, 2021 09:00:00").getTime(); // Update the count down every 1 second
...
var x = setInterval(function () {
  ...
  document.getElementById("segundos").appendChild(spanSegundos); // If the count down is finished, write some text
...
document.addEventListener("DOMContentLoaded", function () {
  window.addEventListener('scroll', function () {
    if (window.scrollY > 200) {
      console.log('scroll');
      document.getElementById('navbar-top').classList.add('navbar-scroll'); // add padding top to show content behind navbar
      // navbar_height = document.querySelector('.navbar').offsetHeight;
      // document.body.style.paddingTop = navbar_height + 'px';
    } else {
      document.getElementById('navbar-top').classList.remove('navbar-scroll'); // remove padding top from body
    ...
    $.ajax({
      ...
      success: function success(data) {
        ...
        data.forEach(function (item) {
          console.log(item);
          html += "<div class=\"speaker-wrap d-md-flex\">\n          <div class=\"img speaker-img\" style=\"background-image: url(".concat(item.imagen, ")\">\n          \n          </div> \n\n        <div class=\"text\">\n          <h2> <a href=\"").concat(item.link, "\"> TITULO DE LA PONENCIA </a> </h2>\n         <p> EXCERPT </p>\n         <span class=\"time\">HORARIO</span>\n                 \n          <h3 class=\"speaker-name\">&mdash; <a href=\"").concat(item.link, "\">").concat(item.titulo, "</a>\n          <span\n          class=\"position\"> Puesto </span></h3>\n          </div>\n          </div>");
        });
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkwoocomerce_theme"] = self["webpackChunkwoocomerce_theme"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["dist/styles"], () => (__webpack_require__("./src/styles.scss")))
